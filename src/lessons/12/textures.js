...
import g3 from './textures/gradients/3.jpg';
import g5 from './textures/gradients/5.jpg';
...
const RESOURCE_FILES = {
  door: {
    [RESOURCE_NAMES.door.color]: color,
    [RESOURCE_NAMES.door.alpha]: alpha,
    [RESOURCE_NAMES.door.ambientOcclusion]: ambientOcclusion,
    [RESOURCE_NAMES.door.height]: height,
    [RESOURCE_NAMES.door.metalness]: metalness,
    [RESOURCE_NAMES.door.normal]: normal,
    [RESOURCE_NAMES.door.roughness]: roughness,
  },
  gradients: {
    [RESOURCE_NAMES.gradients[3]]: g3,
    [RESOURCE_NAMES.gradients[5]]: g5,
  },
  matcaps: {
